...
public class DeletePositionCommandHandler : IRequestHandler<DeletePositionCommand,ResponseDTO<bool>>
{
    private readonly IPositionRepository _repository;
    private readonly IMapper _mapper;
    private IStringLocalizer<Localize> localizer;

    public DeletePositionCommandHandler(IPositionRepository repository,IMapper mapper,IStringLocalizer<Localize> localizer)
    {
    ...
    public async Task<ResponseDTO<bool>> Handle(DeletePositionCommand request, CancellationToken cancellationToken)
    {
        try
        {
