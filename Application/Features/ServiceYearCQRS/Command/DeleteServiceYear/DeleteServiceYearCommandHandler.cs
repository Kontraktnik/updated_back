...
public class DeleteServiceYearCommandHandler : IRequestHandler<DeleteServiceYearCommand,ResponseDTO<bool>>
{
    private readonly IServiceYearRepository _repository;
    private readonly IMapper _mapper;
    private IStringLocalizer<Localize> localizer;

    public DeleteServiceYearCommandHandler(IServiceYearRepository repository,IMapper mapper,IStringLocalizer<Localize> localizer)
    {
    ...
    public async Task<ResponseDTO<bool>> Handle(DeleteServiceYearCommand request, CancellationToken cancellationToken)
    {
        try
        {
