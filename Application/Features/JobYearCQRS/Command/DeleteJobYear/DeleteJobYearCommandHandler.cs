...
public class DeleteJobYearCommandHandler : IRequestHandler<DeleteJobYearCommand,ResponseDTO<bool>>
{
    private readonly IJobYearRepository _repository;
    private readonly IMapper _mapper;
    private IStringLocalizer<Localize> localizer;

    public DeleteJobYearCommandHandler(IJobYearRepository repository,IMapper mapper,IStringLocalizer<Localize> localizer)
    {
    ...
    public async Task<ResponseDTO<bool>> Handle(DeleteJobYearCommand request, CancellationToken cancellationToken)
    {
        try
        {
