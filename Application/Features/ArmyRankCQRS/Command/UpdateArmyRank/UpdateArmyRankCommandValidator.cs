...
public class UpdateArmyRankCommandValidator : AbstractValidator<UpdateArmyRankCommand>
{
    public UpdateArmyRankCommandValidator(IStringLocalizer<Localize> localizer)
    {
        RuleFor(v => v)
