...
public class AddArmyRegionCommandValidator : AbstractValidator<AddArmyRegionCommand>
{
    public AddArmyRegionCommandValidator(IStringLocalizer<Localize> localizer)
    {
