...
public class DeleteSecretLevelCommandHandler : IRequestHandler<DeleteSecretLevelCommand,ResponseDTO<bool>>
{
    private readonly ISecretLevelRepository _repository;
    private readonly IMapper _mapper;
    private IStringLocalizer<Localize> localizer;
    public DeleteSecretLevelCommandHandler(ISecretLevelRepository repository,IMapper mapper,IStringLocalizer<Localize> localizer)
    {
    ...
    public async Task<ResponseDTO<bool>> Handle(DeleteSecretLevelCommand request, CancellationToken cancellationToken)
    {
        try
        {
