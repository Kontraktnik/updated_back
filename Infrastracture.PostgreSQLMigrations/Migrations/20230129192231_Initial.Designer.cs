...
namespace Infrastracture.PostgreSQLMigrations.Migrations
{
    ...
    [Migration("20230129192231_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.DigitalSignModels.DigitalSign", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Models.DigitalSignModels.DigitalSignAttribute", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("DigitalSignAttributes");
                });

            modelBuilder.Entity("Domain.Models.DigitalSignModels.DigitalSignBinary", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("DigitalSignBinaries");
                });

            modelBuilder.Entity("Domain.Models.DigitalSignModels.DigitalSignInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Models.DigitalSignModels.DigitalSign", b =>
                {
                    b.HasOne("Domain.Models.DigitalSignModels.DigitalSignBinary", "BinaryData")
                        .WithMany("DigitalSigns")
                        .HasForeignKey("BinaryDataId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Models.DigitalSignModels.DigitalSignInfo", "Info")
                        .WithMany("DigitalSigns")
                        .HasForeignKey("InfoId");

                    b.HasOne("Domain.Models.UserModels.User", "SignedUser")
                        .WithMany("DigitalSigns")
            ...
            modelBuilder.Entity("Domain.Models.SurveyModels.SurveyExecutor", b =>
                {
                    ...
                    b.HasOne("Domain.Models.SurveyModels.Survey", "Survey")
                        .WithOne("SurveyExecutor")
                        .HasForeignKey("Domain.Models.SurveyModels.SurveyExecutor", "SurveyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Models.SurveyModels.Survey", b =>
                {
                    ...
                    b.Navigation("SurveyDrivers");

                    b.Navigation("SurveyExecutor")
                        .IsRequired();

                    b.Navigation("SurveyRelatives");
                });
